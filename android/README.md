...
```gradle
dependencies {
    implementation 'com.github.apiverve:ascii85encoder-api:1.1.14'
}
```
...
```java
import com.apiverve.ascii85encoder.ASCII85EncoderAPIClient;
import com.apiverve.ascii85encoder.APIResponse;
import com.apiverve.ascii85encoder.APIException;

// Initialize the client
ASCII85EncoderAPIClient client = new ASCII85EncoderAPIClient("YOUR_API_KEY");
...
try {
    ...
    parameters.put("format", "standard");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/ascii85encoder](https://docs.apiverve.com/ref/ascii85encoder)
...
- **Documentation:** [https://docs.apiverve.com/ref/ascii85encoder](https://docs.apiverve.com/ref/ascii85encoder)
- **Issues:** [GitHub Issues](https://github.com/apiverve/ascii85encoder-api/issues)
