// Package ascii85encoder provides a Go client for the ASCII85 Encoder API.
//
// For more information, visit: https://apiverve.com/marketplace/ascii85encoder?utm_source=go&utm_medium=readme
package ascii85encoder
...
const (
	baseURL        = "https://api.apiverve.com/v1/ascii85encoder"
	defaultTimeout = 30 * time.Second
)

// Client is the ASCII85 Encoder API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new ASCII85 Encoder API client.
...
// Execute makes a request to the ASCII85 Encoder API with typed parameters.
//
