...
class ascii85encoderWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/ascii85encoder');
        }
        ...
        this.validationRules = {"text":{"type":"string","required":true},"action":{"type":"string","required":false,"default":"encode"},"format":{"type":"string","required":false,"default":"standard"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/ascii85encoder`);
        }
    }
...
module.exports = ascii85encoderWrapper;
