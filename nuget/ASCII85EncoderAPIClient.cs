...
namespace APIVerve.API.ASCII85Encoder
{
    ...
    /// <summary>
    /// Client for the ASCII85Encoder API
    /// </summary>
    public class ASCII85EncoderAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/ascii85encoder";
        ...
        public ASCII85EncoderAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ASCII85EncoderAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ASCII85EncoderAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ASCII85EncoderQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ASCII85EncoderQueryOptions options)
        {
        ...
        public ResponseObj Execute(ASCII85EncoderQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ASCII85EncoderQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ASCII85EncoderQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ASCII85EncoderQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ASCII85EncoderQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ASCII85EncoderQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ASCII85EncoderQueryOptions options)
        {
