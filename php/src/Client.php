...
namespace APIVerve\Ascii85encoder;
...
/**
 * Client for the ASCII85 Encoder API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/ascii85encoder?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/ascii85encoder';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\Ascii85encoderClient] {$message}\n";
        }
    }
}
