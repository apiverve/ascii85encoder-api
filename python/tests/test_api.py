...
class TestAscii85encoderAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = Ascii85encoderAPIClient(self.api_key)

    @patch('apiverve_ascii85encoder.apiClient.requests.get')
